...
/*   Updated: 2020/06/02 22:21:53 by plamtenz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool parse_simple_tokens(t_token *new, char **txt)
{
...
static bool parse_or_pipe(t_token *new, char **txt)
{
    if (*txt[0] == '|')
    {
        if (!strcmp(*txt, "||") && 
...
static bool parse_greather(t_token *new, char **txt)
{
    if (*txt[0] == '>')
    {
        if (!strcmp(*txt, ">>") && 
...
static bool parse_less(t_token *new, char **txt)
{
    if (*txt[0] == '<')
    {
        if (!strcmp(*txt, "<<") && 
